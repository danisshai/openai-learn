  ...
  return (
    <div>
      ...
      <strong><Chip style={{"marginRight": "5px"}} label="Vista Árbol" onClick={goArbol} /></strong>
        <TextField onChange={(e)=> setTexto(e.target.value)} fullWidth id="input-with-sx" label="¿Qué quieres analizar?: " variant="standard" />
        <SearchIcon onClick={(e)=>search()} style={{"cursor": "pointer"}} fontSize="large" sx={{ color: 'action.active', mr: 1, my: 0.5 }} />
      </Box>
    </div>
  );
}